...
LQR::LQR(){
	...
	this-> x_pos = (float[N_state]){0.01288,	0.16486,	0.37565,	-0.09969,	0.0085,	-0.53532,	1.39363,	-0.2142,	-1.46267,	0.87517};
...
int LQR:: erase(float R_real, float Z_real) {
	...
	state0_pos = (float[N_state]){0.01288,	0.16486,	0.37565,	-0.09969,	0.0085,	-0.53532,	1.39363,	-0.2142,	-1.46267,	0.87517};
