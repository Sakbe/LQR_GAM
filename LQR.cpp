...
LQR::LQR(){
	...
	this-> x_pos = (float[N_state]){0.0098241,	0.1642779,	0.475096,	-0.319521,	-0.3643141,	-0.2360171,	2.0691113,	-0.1528811,	-1.6337618,	1.1334254};
...
int LQR:: erase(float R_real, float Z_real) {
	...
	state0_pos = (float[N_state]){0.0098241,	0.1642779,	0.475096,	-0.319521,	-0.3643141,	-0.2360171,	2.0691113,	-0.1528811,	-1.6337618,	1.1334254};
