...
LQR::LQR(){
	...
	this-> x_pos = (float[N_state]){   0.0074419,	0.0524365,	-0.1598903,	0.8149263,	0.152444,	-0.5632792,	-0.1426424,	-0.3326747,	0.978652,	-0.1796604};
...
int LQR:: erase(float R_real, float Z_real) {
	...
	state0_pos = (float[N_state]){0.0074419,	0.0524365,	-0.1598903,	0.8149263,	0.152444,	-0.5632792,	-0.1426424,	-0.3326747,	0.978652,	-0.1796604};
