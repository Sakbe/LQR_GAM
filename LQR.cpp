...
LQR::LQR(){
	...
	this-> x_pos = (float[N_state]){0.00566,	0.13089,	-0.04151,	-0.03397,	0.18415,	0.16573,	-0.38803,	-0.02171,	0.10527,	0.03794};
...
int LQR:: erase(float R_real, float Z_real) {
	...
	state0_pos = (float[N_state]){0.00566,	0.13089,	-0.04151,	-0.03397,	0.18415,	0.16573,	-0.38803,	-0.02171,	0.10527,	0.03794};
